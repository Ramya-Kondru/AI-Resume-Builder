...
import { ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, DownloadIcon, EyeIcon, EyeOff, EyeOffIcon, FileText, FolderIcon, GraduationCap, Share, Share2Icon, Sparkles, User } from 'lucide-react'
...
const [resumeData,setResumeData]=useState({
  ...
  template:"classic",
  accent_color:'#3B82F6',
  public:false,  //by default resume will be private
})

// if we have any resume available we will load the existing data
...
// execute this function whenever component gets loaded
useEffect(()=>{
  loadExistingResume()
},[])

// if the resume is public it chnages to private or viceversa
...
const saveResume=async()=>{
  try {
    ...
    //remove image from updates ResumeData
  ...
  return (
    <div>
        ...
        {/* when clicked on back to dashboard resumebulider page will redirect to dashboard page */}
         ...
         <div className='lg:col-span-7 max-lg:mt-6'>
                      <div className='relative w-full'>
                        ...
                        justify-end gap-2'>
                          ...
                          <button onClick={changeResumeVisbility} className='flex items-center p-2 px-4 gap-2 text-xs
