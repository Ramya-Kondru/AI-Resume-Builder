...
//    Instead of writing each input manually, you're using:
   ...
   {key:'website', label:'Personal Website', icon:Globe, type:'url' },
    ...
    <div>
        ...
        <div className='flex items-center gap-2'>
            <label>
                {/* if user already has an image displays the image */}
                {data.image ?(
                    <img src={typeof data.image==='string'?data.image:URL.createObjectURL(data.image)} alt='user-image'
                    className='w-16 h-16 rounded-dull object-cover mt-5 ring ring-slate-300
                    hover:opacity-80'/>
                ):(
                    // if user doesn't upload image asks user to upload image
            ...
            {/* removes backgrounf of the image */}
